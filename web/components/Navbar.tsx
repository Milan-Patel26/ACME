        ...
        <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm bg-forest-50/90 border-b border-forest-200">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        >
                            <Button
                                ...
                                className="bg-gradient-to-r from-forest-600 to-forest-500 hover:from-forest-700 hover:to-forest-600 text-white border-0 px-6 py-2 rounded-xl shadow-md hover:shadow-lg transition-all duration-200"
                            >
            ...
            {/* ) : (
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        {["About", "Services", "Tour", "Blog", "Contact"].map(
                            (item) => (
                                <motion.div
                                    key={item}
                                    whileHover={{ y: -2 }}
